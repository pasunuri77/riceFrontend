  ...
  return (
    <div>
      ...
      <div className="card p-6 max-w-2xl">
        ...
        {tab === 'Delivery & Tax' && (
          <form onSubmit={saveSettings} className="space-y-4">
            <div><label className="label-field">Delivery Charges (Rs)</label><input min="0" type="number" value={settings.deliveryCharge} onChange={updateSettingsField('deliveryCharge')} placeholder="0" className="input-field" disabled={loadingSettings} /></div>
            <div><label className="label-field">Free Delivery Above (Rs)</label><input min="0" type="number" value={settings.freeDeliveryThreshold} onChange={updateSettingsField('freeDeliveryThreshold')} placeholder="0" className="input-field" disabled={loadingSettings} /></div>
