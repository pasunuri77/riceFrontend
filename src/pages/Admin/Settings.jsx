      ...
      <div className="card p-6 max-w-2xl">
        ...
        {tab === 'Store Information' && (
          <form onSubmit={save} className="space-y-4">
            ...
            <div><label className="label-field">Store Name</label><input placeholder="RiceBazaar" className="input-field" /></div>
            <div className="grid sm:grid-cols-2 gap-4">
              <div><label className="label-field">GST Number</label><input placeholder="Enter GST number" className="input-field" /></div>
              <div><label className="label-field">Currency</label><input defaultValue="INR (₹)" disabled className="input-field" /></div>
            </div>
            <div className="grid sm:grid-cols-2 gap-4">
              <div><label className="label-field">Phone</label><input placeholder="Enter support phone" className="input-field" /></div>
              <div><label className="label-field">Email</label><input placeholder="Enter support email" className="input-field" /></div>
            </div>
        ...
        {tab === 'Delivery & Tax' && (
          <form onSubmit={save} className="space-y-4">
            <div><label className="label-field">Delivery Charges (₹)</label><input type="number" placeholder="0" className="input-field" /></div>
            <div><label className="label-field">Free Delivery Above (₹)</label><input type="number" placeholder="0" className="input-field" /></div>
            <div><label className="label-field">Tax Percentage (%)</label><input type="number" placeholder="0" className="input-field" /></div>
            <button className="btn-primary">Save Changes</button>
          </form>
        )}
            ...
            {DAYS.map((d) => (
              <div key={d} className="flex items-center justify-between py-2 border-b border-black/5 last:border-0">
                ...
                <div className="flex items-center gap-2">
                  <input type="time" className="input-field !w-32 py-1.5" />
