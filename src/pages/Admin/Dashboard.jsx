...
import { IndianRupee, Users, ClipboardList, Clock, CheckCircle2, Package, PieChart as PieChartIcon, BarChart3, ArrowRight, Receipt } from 'lucide-react'
  ...
  return (
    <div>
      ...
      <div className="grid grid-cols-2 sm:grid-cols-3 lg:grid-cols-6 gap-4 mb-6">
        ...
        <DashboardCard icon={Package} label="Total Products" value={products.length} sub={`${lowStock} low stock`} tint="red" index={5} loading={loading} />
      </div>
