...
const SECTIONS = [
  ...
  { title: '3. Orders & Pricing', body: 'All prices are listed in Indian Rupees (₹) and are subject to change without notice. Orders are confirmed only after successful payment or COD confirmation.' },
